...
* **Evitar usar `new` sin asignar al objeto a una variable.**
...
* **Solo se puede lanzar (`throw`) un objeto `Error`.**
...
* **El `*` en expresiones `yield*` deben tener un espacio en blanco antes y después.**
